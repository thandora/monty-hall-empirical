...
for _ in range(N_TESTS):
    ...
    losers = gen_losers(doors, winner_element)
    decoys = gen_decoys(
        doors, losers, user_door_choice, winner_element, len(losers) - N_TO_UNOPEN
    )
...
print("=================================")
print(f"With {N_DOORS} doors to start, you choose not to open {N_TO_UNOPEN} door(s).")
print(f"Running {N_TESTS} trials.")
print(f"wins: {wins}")
print(f"loses: {loses}")
